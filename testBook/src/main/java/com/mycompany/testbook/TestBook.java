...
public class TestBook {
    ...
    private static void temporaryInProgress(){
        ...
        String[] info6 = {"Montage Of a Heck: Part 1", "Fecal Matters", "Club 27 Publishing Co.", "31227"};
        String[] info7 = {"Montage Of a Heck: Part 2", "Fecal Matters", "Club 27 Publishing Co.", "31227"};
        String[] info8 = {"Montage Of a Heck: Part 3", "Fecal Matters", "Club 27 Publishing Co.", "31227"};
        String[] info9 = {"Montage Of a Heck: Part 4", "Fecal Matters", "Club 27 Publishing Co.", "31227"};
        String[] info10 = {"Montage Of a Heck: Part 5", "Fecal Matters", "Club 27 Publishing Co.", "31227"};
        ...
        Book[] container = new Book[bookRecord.length];
        
        userPrompt userPrompt = new userPrompt(bookRecord, scanner());
